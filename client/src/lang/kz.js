		...
		main: {
			...
			main: {
				...
				ourCourses: {
					...
					courses: {
						pythonDesc:
							'Біздің курс 30 сабақтан/ 5 бөлімнен тұрады. Курсты аяқтағанға дейін сіздің портфолиоңызда 4 жоба болады. Ұзақтығы: 28 апта.',
						javaDesc:
							'Our course consists of 36 lessons/ 6 parts. There are 5 projects in your portfolio before the end of the course. Duration: 28 weeks.',
						cppDesc:
